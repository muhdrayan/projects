...
def calculate_reward(times):
    ...
    cursor.execute("SELECT * FROM users WHERE oid="+str(information[5]))
    information2 = cursor.fetchall()[0]

    print(information2[2], "name"])


    time.sleep(2)
    print(f"Money Added! Now you have {information2[4]} bits in your account!")
